...
const navigate = useNavigate()
    ...
    const handleClick = async (e) => {
      ...
      try {
        state
          ? await axios.put(`http://localhost:8000/posts/update/${state.id}`, {
              title,
              content: value,
              category: cat,
              image: file ? imgUrl : "",
          ...
          : await axios.post(`http://localhost:8000/posts/create`, {
              ...
              admin_id: currentUser?.user.user.id 
            }, {
              headers: {
                'Authorization': `Bearer ${token}`
              }
        ...
        <div className="flex  md:flex-col lg:flex-row p-4 space-y-4 mx-[400px] justify-around lg:space-y-0 lg:space-x-4">
          ...
          <div className="w-full p-4 text-black bg-white rounded-lg shadow-md lg:w-1/3">
            <div className="mb-4">
              ...
              <button className="flex-1 px-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-600"onClick={handleClick}>Publish</button>
                <button />
            ...
            <div className="item">
              ...
              <div className="flex flex-col space-y-2 cat">
                ...
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="typescript">react</label>
                </div>
                <div className="flex items-center">
                  <input
                    type="radio"
                    ...
                    onChange={(e) => setCat(e.target.value)}
                  />
                  <label htmlFor="database">typescript</label>
                </div>
                <div className="flex items-center">
                  <input
                    type="radio"
                    ...
                    onChange={(e) => setCat(e.target.value)}
                  />
                  <label htmlFor="design">Database</label>
                </div>
